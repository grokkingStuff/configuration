...
#+BEGIN_EXPORT html
<img src="https://travis-ci.org/grokkingStuff/configuration.svg" />
#+END_EXPORT
...
#+BEGIN_SRC sh :tangle install.sh :noweb yes :exports code :noweb no-export
#!/usr/bin/env bash
...
*** Spacemacs Configuration                                       :spacemacs:
    ...
    (setq user-full-name "Vishakh Kumar"
      ...
      calendar-latitude 25.2048
      calendar-longitude 55.2708
      calendar-location-name "Dubai, UAE")
    #+END_SRC
...
#+NAME: test
#+BEGIN_SRC sh :padline no :tangle no :noweb yes :noweb: no-export
...
** System library                                              :library:bash:
 ...
 #+NAME: system_library
 #+BEGIN_SRC sh :noweb yes :noweb no-export
...
#+BEGIN_SRC sh :noweb yes :noweb no-export :tangle dotfiles/.bashrc
...
#+NAME: .bashrc
  #+BEGIN_SRC sh :tangle dotfiles/bashrc.txt
...
#+BEGIN_SRC sh :tangle dotfiles/.curlrc
<<.curlrc>>
#+END_SRC
...
**** Configuration                                            :configuration:
 ...
 #+BEGIN_SRC sh :tangle dotfiles/.htoprc
