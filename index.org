...
#+NAME: test
#+BEGIN_SRC sh 
@test "Test if the AssetsManagement folder exists in the Dropbox folder and in the home directory" {
 [ -d ~/Dropbox/AssetManagment ]
 [ -d ~/AssetManagement ]
}
#+END_SRC
...
#+NAME: test
#+BEGIN_SRC sh 
@test "Test if the Business folder exists in the Dropbox folder and in the home directory" {
 [ -d ~/Dropbox/Business ]
 [ -d ~/Business ]
}
#+END_SRC
...
#+NAME: test
#+BEGIN_SRC sh 
@test "Test if the Photoes folder exists in the Dropbox folder and in the home directory" {
 [ -d ~/Dropbox/Photos ]
 [ -d ~/Photos ]
}
#+END_SRC
